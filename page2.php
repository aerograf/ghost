...
$xoopsOption["template_main"] =  $module_dirname ."_page2.tpl";
...
global $xoTheme; 
	$xoTheme->addStyleSheet("modules/" . $module_dirname . "/assets/css/style.css");
	//$xoTheme->addScript(XOOPS_URL . "/browse.php?Frameworks/jquery/jquery.js");
	//$xoTheme->addScript("modules/" . $module_dirname . "/assets/js/script.js");
